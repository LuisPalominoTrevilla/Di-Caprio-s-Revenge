...
public class Level2 implements Screen{
    ...
    //Constructor begins
    public Level2(DiCaprio game, boolean TwoPlayers){
        ...
        map = maploader.load("Inception.tmx");
        ...
        if(TwoPlayers){
            ...
            hud2 = new Hud(game.batch, player2, true, 2);
        }
        hud = new Hud(game.batch, player, false, 2);
        //set the sound
    ...
    public void render(float delta) {
        ...
        if (player.isNextLevel()) {
            game.setScreen(new LoadingScreen(2,game, TwoPlayers));
        }
        if(TwoPlayers){
