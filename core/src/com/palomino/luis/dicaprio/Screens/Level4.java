...
public class Level4 implements Screen {
    ...
    //Constructor begins
    public Level4(DiCaprio game, boolean TwoPlayers){
        ...
        if(TwoPlayers){
            ...
            hud2 = new Hud(game.batch, player2, true, 4);
        }
        hud = new Hud(game.batch, player, false, 4);
        //set the sound
    ...
    public void handleInput(float dt){
        ...
        if((Gdx.input.isKeyJustPressed(Input.Keys.UP)) && (doubleJump > 0)){
            player.b2body.applyLinearImpulse(new Vector2(0,(1.5f * doubleJump)), player.b2body.getWorldCenter(), true);
            doubleJump--;
        }
    ...
    public void SecondPlayerInput(float dt){
        ...
        if((Gdx.input.isKeyJustPressed(Input.Keys.W)) && (doubleJump2 > 0)){
            player2.b2body.applyLinearImpulse(new Vector2(0,(1.5f * doubleJump2)), player2.b2body.getWorldCenter(), true);
            doubleJump2--;
        }
    ...
    public void render(float delta) {
        ...
        if (player.isNextLevel()) {
            game.setScreen(new LoadingScreen(4,game, TwoPlayers));
        }
        if(TwoPlayers){
