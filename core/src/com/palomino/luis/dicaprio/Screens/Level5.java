...
public class Level5 implements Screen {
    ...
    //Constructor begins
    public Level5(DiCaprio game, boolean TwoPlayers){
        ...
        if(TwoPlayers){
            ...
            hud2 = new Hud(game.batch, player2, true, 5);
        }
        hud = new Hud(game.batch, player, false, 5);
        //set the sound
    ...
    public void render(float delta) {
        ...
        if (player.isNextLevel()) {
            game.setScreen(new LoadingScreen(5,game, TwoPlayers));
        }
        if(TwoPlayers){
