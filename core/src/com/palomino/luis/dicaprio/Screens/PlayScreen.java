...
public class PlayScreen implements Screen {
    ...
    //Constructor begins
    public PlayScreen(DiCaprio game, boolean TwoPlayers){
        ...
        map = maploader.load("level1Test.tmx");
        ...
        if(TwoPlayers){
            ...
            hud2 = new Hud(game.batch, player2, true, 1);
        }
        hud = new Hud(game.batch, player, false, 1);
        //set the sound
    ...
    public void render(float delta) {
        ...
        if (player.isNextLevel()) {
            game.setScreen(new LoadingScreen(1,game, TwoPlayers));
        }
        if(TwoPlayers){
